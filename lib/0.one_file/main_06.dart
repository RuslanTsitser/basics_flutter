    ...
    return ListenableBuilder(
        ...
        builder: (context, child) {
          return Scaffold(
            ...
            bottomNavigationBar: CharactersBottomNavigationBar(notifier: notifier),
          );
        });
  }
}
...
class CharactersBody extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return notifier.selectedIndex == 0 ? CharactersList(notifier: notifier) : FavoritesList(notifier: notifier);
  }
}
